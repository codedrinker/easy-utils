...
public class Digest {
	...
	/**
	 * Used for processing in yeepay pay in the process of the H - MAC encryption algorithm
	 * 
	 * @param aValue
	 *            bytes for encode
	 * @param aKey
	 *            a key for encode
	 * @return String a encode value for this object.
	 * 
	 * @author Primos
	 */
